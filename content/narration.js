const narration = {
  ...
  historia: `Antoni Radwan urodził się w 1926 r. we wsi Pławo. Jako 11-latek pomagał ojcu karczować las pod budowę Zakładów Południowych, na własne oczy widząc narodziny COP-u. Wybuch wojny w 1939 r. przekreślił jego plany podjęcia nauki w nowo powołanym Liceum Mechanicznym, które miało mieścić się bezpośrednio na terenie zakładów – w hali Zakładu Mechanicznego (późniejszej hali M-2).
Podczas okupacji Niemcy zezwolili jednak na naukę przedmiotów technicznych, dzięki czemu Antoni odbył praktyki mechaniczne dokładnie w tej samej hali M-2, w której pierwotnie miał się uczyć. Tam, pośród maszyn, zrodził się w nim dwoisty zachwyt: za dnia podziwiał robotników wznoszących potężne konstrukcje, a nocami z lękiem i fascynacji obserwował latające po niebie kilkunastotonowe machiny bojowe.
